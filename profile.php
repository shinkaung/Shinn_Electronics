...
<body>
	<div class="navbar navbar-default navbar-fixed-top"  id="topnav">
		<div class="container-fluid">
			<div class="navbar-header">
				<a href="index.php" class="navbar-brand">Shinn Electronics</a>
			</div>
			...
			<ul class="nav navbar-nav navbar-right">
				<li id='shoppingcart'><a id="carticon" href="cart.php" class="dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-shopping-cart"></span>Cart <span class="badge">2</span>	</a>
					<div class="dropdown-menu" style="width: 400px;">
						<div class="panel panel-success">
							...
							<div class="panel-footer"><a href="cart.php"><span class="glyphicon glyphicon-shopping-cart"></span>Go to Cart</a></div>
						</div>
					</div>
				</li>
	...
	<!-- Slider Begins -->
	 ...
	 <div class="one-time">
	    <div><img src="assets/images/a.jpg" height="300" width="1700"></div>
	    <div><img src="assets/images/b.jpg" height="300" width="1700"></div>
	    <div><img src="assets/images/c.jpg" height="300" width="1700"></div>
	    <div><img src="assets/images/d.jpg" height="300" width="1700"></div>
  	</div>
...
<p> Brought To You By <a href="#">mmsoft</a></p>
</footer></div>
